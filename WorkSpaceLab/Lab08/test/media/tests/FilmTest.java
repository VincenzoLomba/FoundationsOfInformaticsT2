...
public class FilmTest {
	...
	public void setUp() throws Exception {
		...
		film = new Film("Guerre Stellari", 1977, "George Lucas", 127, new String[] { "Mark Hamill", "Harrison Ford", "Carrie Fisher" }, "Fantascienza");
	}
	...
	public void testEqualsObject() {
		...
		Film film2 = new Film("Guerre Stellari", 1977, "George Lucas", 127, new String[] { "Mark Hamill", "Harrison Ford", "Carrie Fisher" }, "Fantascienza");
		assertEquals(film, film2);
		film2 = new Film("L'impero colpisce ancora", 1977, "George Lucas", 135, new String[] { "Mark Hamill", "Harrison Ford", "Carrie Fisher" }, "Fantascienza");
