...
public class Sondaggio {
	...
	protected List<Intervista> getListaInterviste() { return listaInterviste;}
	public Map<String, List<Intervista>> getMappaInterviste() { return mappa; }

	/* "scelta" matches with Intervista::getNome */
	...
	public int getEtaMaxIntervistati() {
		return listaInterviste.stream().mapToInt(iv -> iv.getEta()).max().getAsInt(); 
	}

	public int getEtaMinIntervistati() {
		return listaInterviste.stream().mapToInt(iv -> iv.getEta()).min().getAsInt();
	}

	public int getTotaleIntervistati() { return totaleIntervistati; }
